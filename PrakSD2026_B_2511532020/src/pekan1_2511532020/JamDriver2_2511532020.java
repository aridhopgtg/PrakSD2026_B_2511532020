...
public class JamDriver2_2511532020 {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n--- Input Jam 1 ---");
		Jam_2511532020 j1 = buatJamdariInput (input);
		
		System.out.println("\n--- Input Jam 2 ---");
		Jam_2511532020 j2 = buatJamdariInput (input);
		...
		System.out.println("Durasi (J1 ke J2)   : " + Jam_2511532020.durasiDetik(j1, j2));
		
		Jam_2511532020 jNext = j1.nextSecond();
		System.out.println("Jam 1 detik berikutnya : " + jNext);
		
		Jam_2511532020 jPrev = j1.prevSecond();
		System.out.println("Jam 1 detik sebelumnya : " + jPrev);
		
		Jam_2511532020 jHasilPlus = j1.plus(j2);
		...
		private static Jam_2511532020 buatJamdariInput (Scanner sc) {
			int h, m, s;
			while (true) {
				...
				if (Jam_2511532020.isValid(h, m, s)) {
